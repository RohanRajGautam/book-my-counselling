...
export function AcademicCounsellorListingHeader() {
  ...
  const { data } = useAcademicCounsellors(filters, currentPage)
    ...
    <section className="mt-8 bg-[#f8f9ff] px-6 pt-6 sm:px-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
        <div>
          ...
          <p className="my-4 max-w-2xl text-base leading-7 font-medium text-[var(--color-on-surface-variant)] sm:leading-8">
