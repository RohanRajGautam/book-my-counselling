...
interface CoachForFreshersSearchControlsProps {
  onOpenMobileFilters?: () => void
}

export function CoachForFreshersSearchControls({
  onOpenMobileFilters,
}: CoachForFreshersSearchControlsProps) {
  const { filters, updateFilter } = useCoachForFreshersFilters()
