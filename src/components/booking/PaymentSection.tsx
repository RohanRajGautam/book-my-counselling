      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <div className="relative">
            <CreditCard className="absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-[#434655]" />
            <input
              id="card_number"
              name="card_number"
              type="text"
              ...
              maxLength={19}
              className={`w-full rounded-lg border-none bg-[#eff4ff] py-3 pl-12 pr-4 text-[#121c2a] transition-colors focus:bg-white focus:ring-2 focus:ring-[#004ac6] ${
