    ...
    <section className="bg-[#eef4ff]">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 sm:px-8 md:py-24 lg:grid-cols-[0.82fr_1.18fr] lg:gap-20">
        ...
        <div className="max-w-3xl space-y-9 text-lg leading-8 text-[#434655]">
          ...
          <p>
            Founded by a collective of educators and industry veterans, we realized that
            traditional career services were too generic, while elite mentorship was hidden behind
            closed doors. We set out to bridge this gap, creating a sanctuary where academic rigor
            meets practical industry foresight.
          </p>
          <p>
