...
export function PrivacyHero() {
  return (
    <section className="mx-auto max-w-7xl px-6 pb-8 pt-14 sm:px-8">
      <div className="relative overflow-hidden rounded-[24px] bg-[#eaf1ff] px-8 py-16 sm:px-14">
        <div className="relative z-10 max-w-2xl">
          <p className="mb-6 inline-flex rounded-full bg-[#62f2ad] px-4 py-1.5 font-[family-name:var(--font-headline)] text-[10px] font-bold uppercase tracking-[0.16em] text-[#0b5b4c]">
            Transparency First
          </p>
        ...
        <ShieldCheck className="absolute bottom-8 right-8 h-32 w-32 text-[#121c2a]/10 sm:right-12" />
      </div>
    </section>
  )
}
